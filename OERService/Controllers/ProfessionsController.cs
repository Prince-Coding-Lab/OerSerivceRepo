...
namespace OERService.Controllers
{
    ...
    public class ProfessionsController : ControllerBase
    {
        ...
        public ProfessionsController(IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                ProfessionDataAccess _ProfessionAccess = new ProfessionDataAccess(_iconfiguration);

                DatabaseResponse response = await _ProfessionAccess.GetProfessions();
        ...
        public async Task<IActionResult> GetById(int id)
        {
            try
            {
                ...
                DatabaseResponse response = await _ProfessionAccess.GetProfession(id);
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] CreateProfessionMaster profession)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DatabaseResponse response = await _ProfessionAccess.CreateProfession(profession);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody] UpdateProfessionMaster profession)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                DatabaseResponse response = await _ProfessionAccess.UpdateProfession(profession, id);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                DatabaseResponse response = await _ProfessionAccess.DeleteProfession(id);
